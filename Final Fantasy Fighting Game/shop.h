...
private:
  string
      buy; // string for storing whether or not the user wants to buy something
...
public:
  ...
  bool hasBeenKilled =
      false; // bool for whether or not the enemy at each level has been killed,
             // used to determine whether or not a user can but a level upgrade
