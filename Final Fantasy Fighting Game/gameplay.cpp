...
void Gameplay::instructions() {
  cout
      << "\n-------------------------\nWelcome to... Aetheroa! In CPP "
         "Combat, you will encounter 9 different enemies that you will have to "
         "fight.\nTo fight, you will have three options: attack, block, or use "
         "a health potion.\nYou will acquire swords that do more damage, armor "
         "that resists more damage, and health potions that help regain your "
         "health.\nEach fight will award cash that you can use in the "
         "shop.\nOnce you get the enemy to 0 hp, they will die and you will be "
         "presented with a choice:\n1) continue with your current hp and fight "
         "again for more cash\n2) exit the fight with your cash and enter the "
         "shop.\n\nIn the shop, you are able to use your cash to buy level "
         "upgrades, higher level swords and armor, and more health "
         "potions.\nNote that you can only buy a level upgrade after you've "
         "beaten a fight at your level.\nExit the shop to fight the next enemy "
         "and once you beat all ten, you win!\n\nYou have $500, Good "
         "luck.\n\n--------------------------------------------------\n"
      << endl;
}
...
void Gameplay::initializeUHP() {
  ...
  sharp =
      10 +
      sword; // set sharp to 10 + whatever the sword is set to in its function
}
...
void Gameplay::fighting() {
  ...
  cout << "\nYou have joined a Level " << shopLvl
       << " fight!\n--------------------------------\n\nA wild "
       << enemy.getName(shopLvl) << " has appeared with " << enemyHP
       << "hp!\nYou have " << userHP << " hp. (100 hp + " << armor
       << " armor)\n"
       << endl;
  ...
  while (alive == true) {
    ...
    // get player's move
    cout << "\n---------------\nMake your move.\n---------------\n\nEnter 'A' "
            "for attack, enter 'B' for block, enter 'P' to use a Health "
            "Potion.\nYou have "
         << potions << " Health Potions." << string(7, '\n') << endl;
    cin >> move;
    cout << string(100, '\n');
    ...
    if (userHP > ((100 + armor) * (.9))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]]" << endl;
    } else if (((100 + armor) * (.8)) < userHP &&
               userHP <= ((100 + armor) * (.9))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ]" << endl;
    } else if (((100 + armor) * (.7)) < userHP &&
               userHP <= ((100 + armor) * (.8))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.6)) < userHP &&
               userHP <= ((100 + armor) * (.7))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.5)) < userHP &&
               userHP <= ((100 + armor) * (.6))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.4)) < userHP &&
               userHP <= ((100 + armor) * (.5))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.3)) < userHP &&
               userHP <= ((100 + armor) * (.4))) {
      cout << "[[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.2)) < userHP &&
               userHP <= ((100 + armor) * (.3))) {
      cout << "[[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ] [  ]" << endl;
    } else if (((100 + armor) * (.1)) < userHP &&
               userHP <= ((100 + armor) * (.2))) {
      cout << "[[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ] [  ] [  ]" << endl;
    ...
    // if enemy's hp goes below zero, make sure it just says 0 noy a negative
    // number
    if (enemyHP >= 0) {
      cout << "             " << enemy.getName(shopLvl) << "'s HP: " << enemyHP
           << endl;
    } else if (enemyHP < 0) {
    ...
    if (enemyHP > ((100 + (shopLvl * 20)) * (.9))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.8)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.9))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.7)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.8))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.6)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.7))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.5)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.6))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.4)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.5))) {
      cout << "[[]] [[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.3)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.4))) {
      cout << "[[]] [[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.2)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.3))) {
      cout << "[[]] [[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ] [  ]\n" << endl;
    } else if (((100 + (shopLvl * 20)) * (.1)) < enemyHP &&
               enemyHP <= ((100 + (shopLvl * 20)) * (.2))) {
      cout << "[[]] [[]] [  ] [  ] [  ] [  ] [  ] [  ] [  ] [  ]\n" << endl;
...
void Gameplay::getUserMove(int u) { uMove = u; }

// function to set how much damage the user can take
void Gameplay::setResistance(int a) { armor = a * 25; }

// function to set how much damage the user deals
void Gameplay::setSharpness(int s) { sword = s * 5; }
      ...
      while (y == 0) {
        ...
        if (userHP < 1) {
          ...
          cout << "\n----------------------------------------------------"
                  ...
                  "the fight with your current hp: "
               << userHP
               << ")\n----------------------------------------------------\n"
               << string(5, '\n') << endl;
          cin >> end;
...
void Gameplay::loadPlayer(string loadName) {
  ...
  cout << "\nSword: Level " << swordLvl << "  (" << (10 + (swordLvl * 5))
       << " dps)";
  ...
  cout << "\nArmor: Level " << armorLvl << "  (" << (100 + (armorLvl * 25))
       << "hp)" << endl;
...
void Gameplay::setPlayer(string u) { user = u; }
